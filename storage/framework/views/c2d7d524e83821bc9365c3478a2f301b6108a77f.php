<div class="tab-pane show active" id="nav-robot-txt" role="tabpanel" aria-labelledby="nav-robot-txt-tab">
    <form action="<?php echo e(route('settings.htaccess')); ?>" method="post">
        <?php echo e(csrf_field()); ?>

        <div class="form-group">
            <textarea name="htaccess" rows="15" class="form-control"
                      placeholder="Content of your .htaccess"><?php $htaccess = new \Rastventure\SEO\Services\HtaccessFile();echo $htaccess->get(); ?></textarea>
...
</div><?php /**PATH /var/www/html/packages/laravel-seo-tools-master/SEO/src/Providers/../Resources/views/admin/tabs/htaccess.blade.php ENDPATH**/ ?>