            ...
            <div class="nav-items">  
                ...
                <div class="nav-item">
                    <a class="nav-tab-name">
                        ...
                        style="margin-right:10px; display: inline-block;vertical-align: middle;transform: scale(0.8);"></span>
                        <span class="menu-label"> <?php echo e(__('admin::app.datagrid.locale')); ?>  <?php echo e($allLocales[$currentLocaleCode]); ?></span>
                        <span class="icon arrow-icon"></span>
                    </a>
                    <ul>
                        <?php $__currentLoopData = $allLocales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $code => $name): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>                          
                            <li class="navbar-child">
                                <a href="<?php echo e(url()->current() . '?' . http_build_query(array_merge(request()->all(), ['admin_locale' => $code]))); ?>">                                
                                    <span style="margin-left:47px"> <?php echo e($name); ?></span>
                                </a>
                            </li>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>                         
                    </ul>                             
...
<?php $__env->stopPush(); ?><?php /**PATH /var/www/html/packages/Webkul/Admin/src/Providers/../Resources/views/layouts/mobile-nav.blade.php ENDPATH**/ ?>