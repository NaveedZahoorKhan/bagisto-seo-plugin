<div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel" aria-labelledby="nav-dashboard-tab">
    <article>
        <h1>On Page Seo Tool for Shopconik Ecommerce</h1>
    ...
    <div class="row">
        <div class='col-md-4'>
            <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text lead"><span style="font-size: 60px"><b><?php echo e($data['setting_total'] or 0); ?></b></span>
                        Global settings</p>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="<?php echo e(route('pages.create')); ?>"> <i class="fa fa-plus"></i> Create </a>

                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <p class="card-text lead"><span style="font-size: 60px"><b><?php echo e($data['page_total']); ?></b></span>
        ...
        <div class='col-md-4'>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-8">
                            <a href="<?php echo e(route('meta-tags.index')); ?>">Meta Tags</a>
                        </div>
                        <div class="col-sm-4 text-right">
                            <a href="<?php echo e(route('meta-tags.create')); ?>"> <i class="fa fa-plus"></i> Create </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <p class="card-text lead">
                        <span style="font-size: 60px"><b><?php echo e(isset($data['meta_tag_total'])?$data['meta_tag_total']: 0); ?></b></span>
                        Meta Tags
                    </p>
                </div>
            </div>
...
</div><?php /**PATH /var/www/html/packages/laravel-seo-tools-master/SEO/src/Providers/../Resources/views/admin/tabs/dashboard.blade.php ENDPATH**/ ?>