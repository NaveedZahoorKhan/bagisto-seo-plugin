            ...
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <a href="{{route('pages.create')}}"> <i class="fa fa-plus"></i> Create </a>
        ...
        <div class='col-md-4'>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-8">
                            <a href="{{route('meta-tags.index')}}">Meta Tags</a>
                        </div>
                        <div class="col-sm-4 text-right">
                            <a href="{{route('meta-tags.create')}}"> <i class="fa fa-plus"></i> Create </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
