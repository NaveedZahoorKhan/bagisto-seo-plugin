...
<div class="tab-pane fade  show active" id="nav-site" role="tabpanel" aria-labelledby="nav-site-tab">
    <form action="{{route('admin.seo.settings.store')}}" method="post">
        {{csrf_field()}}
        <div class="form-row">
            <div class="form-group col-sm-6">
                <label for="site-tittle">Site Title</label>
                <input type="text" class="form-control" name="settings[site_title][value]" id="site-tittle" aria-describedby="site-title-help" placeholder="Site title must be below 80 words" max="80" value="{{$model->getValueByKey('site_title')}}">
            ...
            <div class="form-group col-sm-6">
                ...
                <input type="number" class="form-control" id="entries_per_sitemap" value="{{$model->getValueByKey('entries_per_sitemap')}}" name="settings[entries_per_sitemap][value]" placeholder="">
            </div>
        </div>
        <div class="form-row">
