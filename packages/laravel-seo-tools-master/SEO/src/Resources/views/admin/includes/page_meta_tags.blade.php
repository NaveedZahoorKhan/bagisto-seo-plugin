            ...
            <div class="card-body">
                ...
                <div class="tab-content mt-3" id="nav-tabContent">
                    <div class="tab-pane fade show active" id="nav-global" role="tabpanel"
                        ...
                        @include('seo::admin.forms.fields.page_fields',[
                        'model'=> $record
                        ])
                    </div>
