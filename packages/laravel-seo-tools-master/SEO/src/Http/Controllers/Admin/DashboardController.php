...
class DashboardController extends \Webkul\Admin\Http\Controllers\Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('seo::admin.pages.dashboard.index', ['data' => $data]);
    }
    ...
    public function social()
    {
        ...
        return view('seo::admin.pages.dashboard.social', $data);
    }
    ...
    public function sitemap()
    {
        ...
        return view('seo::admin.pages.dashboard.sitemap', $data);
    }
    ...
    {
        $data = [];
        return view('seo::admin.pages.dashboard.tools', $data);
    }
    ...
    {
        $data = [];
        return view('seo::admin.pages.dashboard.advanced', $data);
    }
}
