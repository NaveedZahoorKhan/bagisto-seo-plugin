        ...
        <div class='col-md-4'>
            <div class="card">
                <div class="card-header">
                    <a href="{{route('admin.seo.settings.index')}}">Settings</a>
                </div>
                <div class="card-body">
                    <p class="card-text lead"><span style="font-size: 60px"><b>{{$data['setting_total'] or 0 }}</b></span>
                        Global settings</p>
                </div>
            </div>
        </div>
        <div class='col-md-4'>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-8">
                            <a href="{{route('admin.seo.pages.index')}}">Pages</a>
                        </div>
                        <div class="col-sm-4">
                            <a href="{{route('admin.seo.pages.create')}}"> <i class="fa fa-plus"></i> Create </a>

                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <p class="card-text lead"><span style="font-size: 60px"><b>{{$data['page_total']}}</b></span>
        ...
        <div class='col-md-4'>
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-sm-8">
                            <a href="{{route('admin.seo.meta-tags.index')}}">Meta Tags</a>
                        </div>
                        <div class="col-sm-4 text-right">
                            <a href="{{route('admin.seo.meta-tags.create')}}"> <i class="fa fa-plus"></i> Create </a>
                        </div>
                    </div>
                </div>
                <div class="card-body">
                    <p class="card-text lead">
                        <span style="font-size: 60px"><b>{{isset($data['meta_tag_total'])?$data['meta_tag_total']: 0 }}</b></span>
                        Meta Tags
                    </p>
                </div>
            </div>
